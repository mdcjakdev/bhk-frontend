...
export class MasterPelangganComponent
   ...
   */
  tableProperties = {
    displayedColumns: ['uuid', 'nama', 'npwp', 'hp', 'tipePelanggan', 'alamat'],
    displayedHeaders: ['No', 'Nama', 'NPWP', 'HP', 'Tipe', 'Alamat'],
    levelsOnData: [['uuid'], ['nama'], ['npwp'], ['hp'], ['tipePelanggan'], ['alamat']],
   ...
   */
  openDialogData(data = masterPelangganInit, action = Action.INSERT) {
    const dialogRef = this.dialog.open(MasterPelangganDialogComponent, {
