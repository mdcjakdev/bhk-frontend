...
export function pemesananPembelianDetailWarnaForm(init: any = pemesananPembelianDetailWarnaInit,
  ...
  return new FormBuilder().group({
    ...
    nomorMatching: [{
      value: init.nomorMatching,
      disabled: disables.nomorMatching
...
export function pemesananPembelianForm(init: any = pemesananPembelianInit,
  ...
  return new FormBuilder().group({
    ...
    counterPo: [{
      ...
      disabled: disables.counterPo
    }, statusGeneralization(Validators.required, forGeneralization)],
    detail: new FormBuilder().array(detail),
    salesman: penggunaForm(init.salesman, {...penggunaDisables}, true),
    nomorDokumenPo: [{
      value: qualifyObject(init, 'nomorDokumenPo'),
      disabled: disables.nomorDokumenPo
    }, statusGeneralization(Validators.required, forGeneralization)],
    ...
    nomorPrefixPo: [{
      value: qualifyObject(init, 'nomorPrefixPo'),
      disabled: disables.nomorPrefixPo
    }, statusGeneralization(Validators.required, forGeneralization)],
    statusDokumenPo: {value: qualifyObject(init, 'statusDokumenPo'), disabled: disables.statusDokumenPo},

    tanggalPemesanan: [{
      value: qualifyObject(init, 'tanggalPemesanan'),
      disabled: disables.tanggalPemesanan
    }, statusGeneralization(Validators.required, forGeneralization)],
    ...
    namaPic: [{
      value: qualifyObject(init, 'namaPic'),
      disabled: disables.namaPic
    }, statusGeneralization(Validators.required, forGeneralization)],
